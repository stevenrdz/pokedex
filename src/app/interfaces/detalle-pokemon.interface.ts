// To parse this data:
//
//   import { Convert, DetallePokemon } from "./file";
//
//   const detallePokemon = Convert.toDetallePokemon(json);
//
...
export class Convert {
    public static toDetallePokemon(json: string): DetallePokemon {
        return cast(JSON.parse(json), r("DetallePokemon"));
    }

    public static detallePokemonToJson(value: DetallePokemon): string {
        return JSON.stringify(uncast(value, r("DetallePokemon")), null, 2);
    }
}
