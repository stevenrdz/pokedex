// To parse this data:
//
//   import { Convert, HabilidadesPokemon } from "./file";
//
//   const habilidadesPokemon = Convert.toHabilidadesPokemon(json);
//
...
export class Convert {
    public static toHabilidadesPokemon(json: string): HabilidadesPokemon {
        return cast(JSON.parse(json), r("HabilidadesPokemon"));
    }

    public static habilidadesPokemonToJson(value: HabilidadesPokemon): string {
        return JSON.stringify(uncast(value, r("HabilidadesPokemon")), null, 2);
    }
}
